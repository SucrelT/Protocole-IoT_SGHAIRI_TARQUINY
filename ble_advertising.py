...
def adv_payload(limited_disc=False, br_edr=False, name='WB55-MPY-TARQUINY', services=None, appearance=0, manufacturer=0):
	payload = bytearray()
...
# # def adv_payload(limited_disc=False, br_edr=False, name=None, services=None, appearance=0):
# 	# payload = bytearray()
#
# 	# def _append(adv_type, value):
# 		# nonlocal payload
